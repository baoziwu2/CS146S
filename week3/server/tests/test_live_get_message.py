...
def test_get_message_full(live_gmail_tools):
    ...
    search_result = live_gmail_tools.gmail_search_messages(query="in:inbox", max_results=1)
    ...
    # Get full message
    result = live_gmail_tools.gmail_get_message(message_id=message_id, fmt="full")
...
def test_get_message_metadata(live_gmail_tools):
    ...
    # Get metadata only
    result = live_gmail_tools.gmail_get_message(message_id=message_id, fmt="metadata")
...
def test_get_message_not_found(live_gmail_tools):
    ...
    result = live_gmail_tools.gmail_get_message(message_id="nonexistent_12345", fmt="full")
