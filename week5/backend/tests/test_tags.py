...
def test_attach_tag_to_note(client):
    ...
    note_id = client.post("/notes/", json={"title": "Tagged Note", "content": "content"}).json()["data"]["id"]
...
def test_detach_tag_from_note(client):
    ...
    note_id = client.post("/notes/", json={"title": "Detach note", "content": "content"}).json()["data"]["id"]
...
def test_note_read_includes_tags(client):
    ...
    note_id = client.post("/notes/", json={"title": "Note with tags", "content": "content"}).json()["data"]["id"]
...
def test_notes_list_includes_tags(client):
    ...
    note_id = client.post("/notes/", json={"title": "Listed tag note", "content": "content"}).json()["data"]["id"]
...
def test_attach_nonexistent_tag_returns_404(client):
    ...
    note_id = client.post("/notes/", json={"title": "Note", "content": "content"}).json()["data"]["id"]
...
def test_filter_notes_by_tag(client):
    ...
    note1_id = client.post("/notes/", json={"title": "Tagged", "content": "has tag"}).json()["data"]["id"]
...
def test_cascade_delete_note_keeps_tag(client):
    ...
    note_id = client.post("/notes/", json={"title": "Cascade", "content": "content"}).json()["data"]["id"]
...
def test_cascade_delete_tag_keeps_note(client):
    ...
    note_id = client.post("/notes/", json={"title": "Note survives", "content": "content"}).json()["data"]["id"]
